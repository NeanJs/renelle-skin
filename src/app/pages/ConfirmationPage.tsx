      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="p-8 text-center mb-6">
            <div className="w-16 h-16 bg-[#F2F1EF] border border-border flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="p-6 mb-6">
            ...
            <ol className="space-y-4">
              <li className="flex gap-3">
                <div className="w-8 h-8 bg-foreground text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm">
                  1
                </div>
                <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button asChild className="flex-1 bg-foreground hover:bg-foreground/85">
          ...
          {/* Help */}
          <Card className="p-6 mt-6 bg-[#F7F6F4] border-neutral-200">
