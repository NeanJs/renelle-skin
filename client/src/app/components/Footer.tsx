  ...
  return (
    <footer className="bg-foreground text-white mt-auto">
      ...
      <div className="border-b border-white/8">
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-5">
            <div>
              <p
                className={`${labelStyles.container} mb-1 text-white/40`}
                style={{ fontSize: "0.62rem", letterSpacing: labelStyles.letterSpacing }}
              >
                Newsletter
              </p>
      ...
      <div className="container mx-auto px-6 pt-16 pb-10">
        ...
        <div className="border-t border-white/10 pt-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            {["Visa", "MC", "AMEX", "Apple Pay", "Google Pay"].map((method) => (
              <div
                key={method}
                className="px-2.5 py-1 border border-white/15 rounded text-white/40 bg-white/5 transition-colors hover:text-white/60"
        ...
        <div
          className="mt-8 text-xs text-white/30 text-center transition-colors"
