...
import { OrderDetailsPage } from "@/app/pages/account/OrderDetailsPage";
import { AuthProvider } from "@/lib/context/AuthContext";
import { StoreCartInitializer } from "./config/StoreCartIntializer";

export default function App() {
  return (
    <AuthProvider>
      <StoreCartInitializer />
      <Router>
        ...
        <div className="min-h-screen flex flex-col bg-background">
          ...
          <Routes>
            ...
            <Route path="/subscriptions/:kitId" element={<KitDetailsPage />} />
